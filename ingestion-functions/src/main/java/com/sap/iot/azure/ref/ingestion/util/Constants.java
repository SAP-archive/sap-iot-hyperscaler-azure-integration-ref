...
public class Constants {
    ...
    public static final String PROCESSED_TIMESERIES_IN_CONNECTION_STRING = "processed-timeseries-in-connection-string";
    public static final String PROCESSED_TIMESERIES_IN_EVENT_HUB = "sap.iot.abstract.processed_timeseries_in.v1";
    public static final String PROCESSED_TIMESERIES_IN_EVENT_HUB_CONSUMER_GROUP = "sap-iot-ingestion-avro-parser-cg";

    //EventHub Constants
    public static final String PROCESSED_TIMESERIES_CONNECTION_STRING_PROP = "processed-timeseries-connection-string";
    ...
    public static final String TRANSFORM_TYPE_IOTS = "IOTS";
