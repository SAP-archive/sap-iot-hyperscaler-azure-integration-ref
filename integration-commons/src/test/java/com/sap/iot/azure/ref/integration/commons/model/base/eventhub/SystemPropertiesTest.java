...
public class SystemPropertiesTest {
    ...
    @Test
    public void testIoTHubSystemProperties() {
        //IoT Hub System Properties have to be handled slightly different.
        //Here the partition key has to be derived from the iot hub device id.
        systemPropertiesMap.put(CommonConstants.PARTITION_KEY, null);
        systemPropertiesMap.put(CommonConstants.IOT_HUB_DEVICE_ID, systemProperties.getPartitionKey());
